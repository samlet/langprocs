...
import com.samlet.langprocs.chinese.utility.TestUtility;
...
public class DemoCRFLexicalAnalyzer extends TestUtility
{
    public static void main(String[] args) throws IOException
    {
        ...
        {
            Sentence sent=analyzer.analyze(sentence);
            System.out.println(sent);
            System.out.println(sent.translateLabels());
//            System.out.println(analyzer.analyze(sentence).translateCompoundWordLabels());
